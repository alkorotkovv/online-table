...
import {secondaryHeadCells} from '../../constants';
import PropTypes from 'prop-types';
import TableCell from "@mui/material/TableCell";
import {useDispatch, useSelector} from "react-redux";
import axios from "axios";

EnhancedSecondaryTableHead.propTypes = {
...
export default function EnhancedSecondaryTableHead(props) {
  ...
  return (
    <TableHead>
      <TableRow>
        ...
        {secondaryHeadCells.map(( headCell, index) =>(
          <HeaderTableCell style={ headCell.fixed?{left: secondaryHeadCells.slice(0, index).reduce(function (sum, column) { return sum + column.width}, 54), minWidth: headCell.width}
